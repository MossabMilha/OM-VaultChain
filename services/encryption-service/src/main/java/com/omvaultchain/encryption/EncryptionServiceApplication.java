...
//		FileHashService Hash_Service = new FileHashService();
...
//		String hashedData = Hash_Service.computeSHA256(plaintext);
...
//		System.out.println("The Hashed Data : "+hashedData);
//		System.out.println("Decrypted Data (String) : " + new String(decryptedData));
//
//		Path path = Paths.get("C:/Users/PC/Downloads/TECH EXPERIENCE 7th SPONSORSHIP PROPOSAL-ENG.pdf");
//		System.out.println("The Hashed Pdf : "+Hash_Service.computeSHA256(path));
//
