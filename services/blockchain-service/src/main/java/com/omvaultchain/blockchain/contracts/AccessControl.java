...
public class AccessControl extends Contract {
    ...
    public List<AccessRevokedEventResponse> getAccessRevokedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(ACCESSREVOKED_EVENT, transactionReceipt);
    ...
    public RemoteFunctionCall<TransactionReceipt> hasAccess(String cid, String user) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_HASACCESS, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Utf8String(cid), 
                new org.web3j.abi.datatypes.Address(160, user)), 
