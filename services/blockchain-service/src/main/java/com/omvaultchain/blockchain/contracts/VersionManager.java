...
public class VersionManager extends Contract {
    ...
    public List<FileStatusChangedEventResponse> getFileStatusChangedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(FILESTATUSCHANGED_EVENT, transactionReceipt);
    ...
    public Flowable<FileStatusChangedEventResponse> fileStatusChangedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new Function<Log, FileStatusChangedEventResponse>() {
            @Override
            public FileStatusChangedEventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues = extractEventParametersWithLog(FILESTATUSCHANGED_EVENT, log);
                FileStatusChangedEventResponse typedResponse = new FileStatusChangedEventResponse();
    ...
    public Flowable<FileStatusChangedEventResponse> fileStatusChangedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
    ...
    public List<RolledBackEventResponse> getRolledBackEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(ROLLEDBACK_EVENT, transactionReceipt);
    ...
    public Flowable<RolledBackEventResponse> rolledBackEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new Function<Log, RolledBackEventResponse>() {
            @Override
            public RolledBackEventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues = extractEventParametersWithLog(ROLLEDBACK_EVENT, log);
                RolledBackEventResponse typedResponse = new RolledBackEventResponse();
                typedResponse.log = log;
                typedResponse.fileId = (byte[]) eventValues.getIndexedValues().get(0).getValue();
                typedResponse.toVersion = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
    ...
    public Flowable<RolledBackEventResponse> rolledBackEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
    ...
    public RemoteFunctionCall<TransactionReceipt> getCurrentVersion(String fileId) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_GETCURRENTVERSION, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Utf8String(fileId)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteFunctionCall<TransactionReceipt> getFileStatus(String fileId) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_GETFILESTATUS, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Utf8String(fileId)), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<TransactionReceipt> getVersionAt(String fileId, BigInteger index) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_GETVERSIONAT, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Utf8String(fileId), 
    ...
    public RemoteFunctionCall<TransactionReceipt> getVersionCount(String fileId) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_GETVERSIONCOUNT, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Utf8String(fileId)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteFunctionCall<TransactionReceipt> rollbackToVersion(String fileId, BigInteger versionNumber) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
